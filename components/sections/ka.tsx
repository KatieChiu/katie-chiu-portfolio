...
export function KA() {
  ...
  return (
    <section
      id="ka"
      ref={ref}
      className="relative overflow-hidden border-t border-border bg-coffee-dark text-beige-light"
    >
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 py-28 md:px-10 md:py-40">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            <Reveal delay={0.1}>
              <p className="mt-8 max-w-xl text-pretty text-lg leading-relaxed text-beige/80">
                KA es una solución de desarrollo tecnológico enfocada en crear
                software, aplicaciones web y soluciones digitales para empresas
                y negocios que buscan optimizar sus procesos y fortalecer su
                presencia digital.
              </p>
            </Reveal>
            ...
            <Reveal delay={0.15}>
              <div className="mt-8 flex items-center gap-4 border-t border-beige/15 pt-6 font-mono text-xs uppercase tracking-[0.2em] text-beige/60">
                ...
                <span>Software</span>
                <span className="text-ocre">→</span>
                <span className="text-beige-light">Digital Solutions</span>
              </div>
            </Reveal>
          </div>
          ...
          <div className="lg:col-span-5 lg:pt-4">
            <Reveal>
              <p className="font-mono text-xs uppercase tracking-[0.25em] text-ocre">
                Servicios
              </p>
            </Reveal>

            <Stagger
              className="mt-5 grid grid-cols-2 gap-px overflow-hidden rounded-sm border border-beige/15 bg-beige/15"
              gap={0.06}
            >
              {kaServices.map((service) => (
                <StaggerItem
                  key={service}
                  className="bg-coffee-dark p-5 transition-colors hover:bg-coffee"
                >
                  <span className="text-sm font-medium leading-tight text-beige-light">
                    {service}
                  </span>
                </StaggerItem>
              ))}
